...
public class GetProbability
{
  ...
  public void run()
  {
    try {
      ...
      ModulesFile modulesFile = prism.parseModelFile(new File("DonovanYeastPolarization/yeastPolarization.sm"));
      ...
      int countPathsUntil = 237300;

      for (int iii = 0; iii < 237300; iii++) {
        
        System.out.println("Path " + iii);
      ...
      System.out.printf("Total Path Length: %d\n",totalLength);
